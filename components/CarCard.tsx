  ...
  return (
    <div className="car-card group">
      <div className="car-card__content">
        ...
        <span className='self-start text-[14px] leading-[17px] font-semibold'>CHF</span>
        {carRent}
        ...
        <div className='relative flex w-full mt-2'>
            ...
            <div className='car-card__btn-container'>
                <CustomButton title="View More" containersStyles='w-full py-[16px] rounded-full bg-primary-blue'
